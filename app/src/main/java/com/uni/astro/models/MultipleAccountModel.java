...
public class MultipleAccountModel implements Serializable {
    ...
    String id,fName,lName,uName,uBio,uLink,gender,uPic,uGif,uWallet,uTotalCoinsAllTime,uPayoutId,authToken,phoneNo,email,socialId
    ...
    public String getuTotalCoinsAllTime() {
        return uTotalCoinsAllTime;
    }

    public void setuTotalCoinsAllTime(String uTotalCoinsAllTime) {
        this.uTotalCoinsAllTime = uTotalCoinsAllTime;
    }
}