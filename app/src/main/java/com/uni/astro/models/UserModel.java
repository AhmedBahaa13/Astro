...
public class UserModel implements Serializable {
    ...
    String id,firstName,lastName,gender,bio,website,dob,social_id,email,phone,password,role,username,socialType
            ...
            ,button,profileView;
    private String profilePic,profileGif;
    String block,blockByUser;
    double lat,lng;
    long wallet,visitorCount,total_all_time_coins,notificationCount;
    ...
    public long getTotal_all_time_coins() {
        return total_all_time_coins;
    }

    public void setTotal_all_time_coins(long total_all_time_coins) {
        this.total_all_time_coins = total_all_time_coins;
    }
}