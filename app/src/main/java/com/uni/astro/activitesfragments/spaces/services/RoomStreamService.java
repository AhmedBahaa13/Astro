package com.uni.astro.activitesfragments.spaces.services;
...
import com.uni.astro.activitesfragments.spaces.voicecallmodule.openacall.VoiceStreamingNonUiChat;
...
public class RoomStreamService extends Service {
    ...
    private void startRoomStreaming(String roomId,String userId) {
        streamingInstance=new VoiceStreamingNonUiChat((Astro) getApplication());
