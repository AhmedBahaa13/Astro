package com.uni.astro.activitesfragments.profile.uservideos;
...
import com.uni.astro.activitesfragments.profile.creatorplaylist.CreatePlaylistA;
import com.uni.astro.activitesfragments.WatchVideosA;
import com.uni.astro.adapters.PlaylistTitleAdapter;
...
import com.uni.astro.adapters.MyVideosAdapter;
import com.uni.astro.models.PlaylistTitleModel;
import com.uni.astro.R;
import com.uni.astro.apiclasses.ApiLinks;
import com.uni.astro.simpleclasses.SpacesItemDecoration;
...
public class UserVideoF extends Fragment {
    ...
    public void updateUserData(String userId,String blockedByUserName,String isUserAlreadyBlock)
    {
        this.userId=userId;
        this.blockedByUserName=blockedByUserName;
        this.isUserAlreadyBlock=isUserAlreadyBlock;
        callApiMyvideos(true);
    }
